...
impl SpritePreset {
    ...
    pub fn filepath(&self) -> PathBuf {
        match self {
            ...
            SpritePreset::Khung =>"sprite/othello/khung.png",
            SpritePreset::Black =>"sprite/othello/black.png",
            SpritePreset::White =>"sprite/othello/white.png",
            SpritePreset::Diem =>"sprite/othello/diem.png",
            SpritePreset::Newgame =>"sprite/othello/newgame.png",
    ...
    pub fn variant_iter() -> IntoIter<SpritePreset, 86> {
        static SPRITE_PRESETS: [SpritePreset; 86] = [
